...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <Badge
        variant={
          row.original.status.includes("бэлэн") ||
          row.original.status.includes("ирсэн")
            ? "secondary"
            : "outline"
        }
      >
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="text-right font-medium">{row.original.weight}</div>
    ),
  },
  {
    accessorKey: "price",
  ...
  },
  {
    ...
    header: "Date",
    cell: ({ row }) => (
      <span>{moment(row.original.date).format("YYYY-MM-DD")}</span>
    ),
  },
    ...
    cell: () => (
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-32">
          ...
          <DropdownMenuItem>Track Detail</DropdownMenuItem>
          <DropdownMenuSeparator />
    ...
    >
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select defaultValue="outline">
          ...
          <SelectContent>
            <SelectItem value="outline">All Tracks</SelectItem>
            <SelectItem value="past-performance">Salbar1</SelectItem>
            <SelectItem value="key-personnel">Salbar2</SelectItem>
            <SelectItem value="focus-documents">Salbar3</SelectItem>
          </SelectContent>
        </Select>
